  ...
  for (const file of options.files) {
    if (typeof file === "string") {
      ...
      for (const found of glob.globSync(of.src, globOptions))
        files.push(
          __spreadProps(__spreadValues({}, of), {
            src: found,
            dst: import_node_path.default.join(
              (_a = of.dst) != null ? _a : "",
              import_node_path.default.dirname(found),
            ),
...
function serve(options) {
  ...
  return {
    ...
    configResolved: async (configResolved) => {
      ...
      srcDir =
        options.root && import_node_path2.default.isAbsolute(options.root)
          ? options.root
          : import_node_path2.default.resolve(config.root, (_a = options.root) != null ? _a : "")
    },
    ...
    watchChange: async (filepath, change) => {
      ...
      const key = import_node_path2.default.posix.join(
        "/",
        import_node_path2.default
          .relative(srcDir, filepath)
          .replaceAll(import_node_path2.default.sep, import_node_path2.default.posix.sep),
      )
